...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(1)
            ...
            os.system('xdg-open https://www.facebook.com/Report.xudi.nah.bhai')
    else:
        print "\033[1;97mACCESS DENIED"
        os.system('xdg-open https://www.facebook.com/Report.xudi.nah.bhai')
def login():
	...
	try:
		...
		jalan(' \033[1;97m   âœ§ \033[1;97mðŸ‘‰ : \033[1;97mThe Terminators King Of Facebook' ) 
...
def super():
	...
	os.system('clear')
	print logo
	print "\033[1;97mâœ§ \033[1;97m1.\x1b[1;97mHackFriend List ID."
	print "\033[1;97mâœ§ \033[1;97m2.\x1b[1;97mHack Public ID."
